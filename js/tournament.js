...
(function () {
  ...
  function startTournament(id) {
    ...
    // Используем глобальную функцию createBracket из engine.js (без new!)
  ...
  function advanceRound(id) {
    ...
    // Используем глобальную функцию finalizeRound из engine.js (без new!)
    const result = finalizeRound(t);
